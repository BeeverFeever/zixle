...
pub const APIENTRYP = @compileError("unable to translate C expr: unexpected token ''"); // /home/beever/dev/zixle/glad/include/glad/glad.h:39:9
pub const GLAPI = @compileError("unable to translate C expr: unexpected token 'extern'"); // /home/beever/dev/zixle/glad/include/glad/glad.h:79:11
